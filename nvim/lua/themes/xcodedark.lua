...
-- Xcode Dark palette: https://github.com/arzg/vim-colors-xcode
local color = {
  -- Base
  background   = "#292a30",
  dark         = "#1e1f24",
  ...
  dark_gray    = "#53606e",
  -- Syntax
  pink         = "#ff7ab2",  -- keywords
  red          = "#ff8170",  -- errors, exceptions
  teal         = "#78c2b3",  -- types
  light_teal   = "#acf2e4",  -- string escapes, special
  yellow       = "#ffa14f",  -- macros, builtins, preprocessor
  light_yellow = "#d9c97c",  -- numbers
  blue         = "#4eb0cc",  -- functions
  light_blue   = "#6bdfff",  -- constructors, special functions
  purple       = "#b281eb",  -- constants
  light_purple = "#dabaff",  -- type params, light constants
  green        = "#84b360",  -- strings
  light_green  = "#b0e687",  -- string interpolation
}
...
M.setup = function(args)
  ...
  if vim.fn.has("nvim-0.13") == 0 then
    vim.cmd("echohl WarningMsg | echo 'nvim >= 0.13 required' | echohl None")
  end
...
M.configure_highlights = function()
  ...
  hi(0, "TermCursorNC",  { bg = color.dark_gray,   fg = color.background })
  hi(0, "iCursor",       { bg = color.blue,        fg = color.background })
  ...
  hi(0, "Search",        { bg = color.light_yellow, fg = color.background })
  hi(0, "IncSearch",     { bg = color.yellow,       fg = color.background })
  hi(0, "Substitute",    { bg = color.light_yellow, fg = color.background })
  ...
  hi(0, "MatchParen",    { fg = color.light_blue, bold = true })

  hi(0, "NonText",       { fg = color.medium_gray })
  hi(0, "SpecialKey",    { fg = color.comment })
  hi(0, "Whitespace",    { fg = color.medium_gray })

  hi(0, "Directory",     { fg = color.blue })
  hi(0, "Title",         { fg = color.blue, bold = true })
  ...
  hi(0, "Question",      { fg = color.blue, bold = true })
  ...
  hi(0, "String",     { fg = color.green })
  hi(0, "Character",  { fg = color.green })
  hi(0, "Number",     { fg = color.light_yellow })
  hi(0, "Boolean",    { fg = color.yellow })
  hi(0, "Float",      { fg = color.light_yellow })
  hi(0, "Identifier", { fg = color.foreground })
  hi(0, "Function",   { fg = color.blue })
  hi(0, "Statement",  { fg = color.pink })
  hi(0, "Conditional",{ fg = color.pink })
  hi(0, "Repeat",     { fg = color.pink })
  hi(0, "Label",      { fg = color.light_yellow })
  hi(0, "Operator",   { fg = color.light_gray })
  hi(0, "Keyword",    { fg = color.pink })
  hi(0, "Exception",  { fg = color.red })
  hi(0, "PreProc",    { fg = color.yellow })
  hi(0, "Include",    { fg = color.pink })
  hi(0, "Define",     { fg = color.yellow })
  hi(0, "Macro",      { fg = color.yellow })
  hi(0, "Type",       { fg = color.teal })
  hi(0, "StorageClass",{ fg = color.pink })
  hi(0, "Structure",  { fg = color.teal })
  hi(0, "Typedef",    { fg = color.teal })
  hi(0, "Special",    { fg = color.light_teal })
  hi(0, "SpecialChar",{ fg = color.light_teal })
  hi(0, "Delimiter",  { fg = color.light_gray })
  hi(0, "Debug",      { fg = color.red })
  hi(0, "Error",      { bg = color.red, fg = color.background })
  hi(0, "Todo",       { bg = color.selection, fg = color.light_yellow })
  hi(0, "Underlined", { fg = color.blue, underline = true })
  hi(0, "Ignore",     { fg = color.dark })
  hi(0, "Tag",        { fg = color.light_yellow })
  hi(0, "Bold",       { bold = true })

  -- ── Treesitter ────────────────────────────────────────────────────────────
  hi(0, "TSAnnotation",    { fg = color.yellow })
  hi(0, "TSAttribute",     { fg = color.yellow })
  hi(0, "TSBoolean",       { fg = color.yellow })
  hi(0, "TSCharacter",     { fg = color.green })
  hi(0, "TSComment",       { fg = color.comment, italic = true })
  hi(0, "TSConditional",   { fg = color.pink })
  hi(0, "TSConstant",      { fg = color.purple })
  hi(0, "TSConstBuiltin",  { fg = color.yellow, italic = true })
  hi(0, "TSConstantBuiltin",{ fg = color.yellow, italic = true })
  hi(0, "TSConstMacro",    { fg = color.yellow })
  ...
  hi(0, "TSFuncBuiltin",   { fg = color.yellow, italic = true })
  hi(0, "TSFuncMacro",     { fg = color.yellow })
  hi(0, "TSFunction",      { fg = color.blue })
  hi(0, "TSFunctionCall",  { fg = color.light_teal })
  hi(0, "TSMethodCall",    { fg = color.light_teal })
  hi(0, "TSInclude",       { fg = color.pink })
  hi(0, "TSKeyword",       { fg = color.pink })
  hi(0, "TSKeywordFunction",{ fg = color.pink })
  hi(0, "TSKeywordOperator",{ fg = color.pink })
  hi(0, "TSLabel",         { fg = color.light_yellow })
  hi(0, "TSLiteral",       { fg = color.green })
  hi(0, "TSMethod",        { fg = color.blue })
  hi(0, "TSNamespace",     { fg = color.teal })
  ...
  hi(0, "TSRepeat",        { fg = color.pink })
  hi(0, "TSString",        { fg = color.green })
  ...
  hi(0, "TSTag",           { fg = color.light_yellow })
  hi(0, "TSTagDelimiter",  { fg = color.light_gray })
  hi(0, "TSText",          { fg = color.foreground })
  hi(0, "TSTitle",         { fg = color.blue, bold = true })
  hi(0, "TSType",          { fg = color.teal })
  hi(0, "TSTypeBuiltin",   { fg = color.yellow, italic = true })
  hi(0, "TSTypeDefinition",{ fg = color.teal })
  hi(0, "TSURI",           { fg = color.blue, underline = true })
  hi(0, "TSUnderline",     { underline = true })
  hi(0, "TSVariable",      { fg = color.foreground })
  hi(0, "TSVariableBuiltin",{ fg = color.yellow, italic = true })
  ...
  hi(0, "DiagnosticInfo",               { fg = color.blue })
  hi(0, "DiagnosticHint",               { fg = color.teal })
  hi(0, "DiagnosticUnderlineError",     { sp = color.red,    undercurl = true })
  hi(0, "DiagnosticUnderlineWarn",      { sp = color.yellow, undercurl = true })
  hi(0, "DiagnosticUnderlineInformation",{ sp = color.blue,  undercurl = true })
  hi(0, "DiagnosticUnderlineHint",      { sp = color.teal,   undercurl = true })
  ...
  if M.config.opt.integrations.nvim_cmp then
    ...
    hi(0, "CmpItemAbbrMatch",       { fg = color.blue })
    hi(0, "CmpItemAbbrMatchFuzzy",  { fg = color.blue })
    hi(0, "CmpItemKindDefault",     { fg = color.blue })
    hi(0, "CmpItemKindClass",       { fg = color.teal })
    hi(0, "CmpItemKindConstant",    { fg = color.purple })
    hi(0, "CmpItemKindConstructor", { fg = color.light_blue })
    hi(0, "CmpItemKindEnum",        { fg = color.teal })
    hi(0, "CmpItemKindEnumMember",  { fg = color.light_purple })
    hi(0, "CmpItemKindEvent",       { fg = color.teal })
    hi(0, "CmpItemKindField",       { fg = color.foreground })
    hi(0, "CmpItemKindFunction",    { fg = color.blue })
    hi(0, "CmpItemKindInterface",   { fg = color.teal })
    hi(0, "CmpItemKindKeyword",     { fg = color.pink })
    hi(0, "CmpItemKindMethod",      { fg = color.blue })
    ...
    hi(0, "CmpItemKindStruct",      { fg = color.teal })
  ...
  if M.config.opt.integrations.dap_nvim then
    ...
    hi(0, "DapUIScope",                  { fg = color.light_teal })
    hi(0, "DapUISource",                 { fg = color.light_purple })
    hi(0, "DapUIStepBack",               { fg = color.blue })
    hi(0, "DapUIStepBackNC",             { fg = color.blue })
    hi(0, "DapUIStepInto",               { fg = color.blue })
    hi(0, "DapUIStepIntoNC",             { fg = color.blue })
    hi(0, "DapUIStepOut",                { fg = color.blue })
    hi(0, "DapUIStepOutNC",              { fg = color.blue })
    hi(0, "DapUIStepOver",               { fg = color.blue })
    hi(0, "DapUIStepOverNC",             { fg = color.blue })
  ...
  hi(0, "GitGutterChange",       { fg = color.blue })
  ...
  hi(0, "gitcommitDiscardedType",  { fg = color.blue })
  hi(0, "gitcommitHeader",         { fg = color.pink })
  ...
  hi(0, "NeoTreeDirectoryName",        { fg = color.yellow })
  ...
  hi(0, "User4", { bg = color.selection, fg = color.blue })
